...
<div className="absolute inset-0" style={{ zIndex: 0 }}>
      ...
      <Navbar />
      <main className="px-4 py-24 flex flex-col items-center justify-center text-center">
        <div className="hero min-h-screen flex flex-col items-center justify-center dark:b dark:text-dark-text z-10">
        <div className="flex items-center justify-center space-x-4">
            <h1 className="text-9xl font-bold mb-4 text-gray-900 dark:text-dark-card">
              Instinct
            </h1>
            {/* Alpha Badge */}
            <div className="px-4 py-2 bg-indigo-600 text-white text-2xl font-bold rounded-full shadow-md transform rotate-12">
              Alpha 0.1.9
            </div>
          </div>
          
          <div className="h-12 flex items-center justify-center"> {/* Fixed height for the typing animation container */}
  <TypingAnimation />
</div>
...
<div className="flex-col items-start min-w-full mx-auto"> {/* Fixed width for the container */}
          <SearchBar
              value={searchInput}
  ...
  {selectedCategories.map((category) => (
    <div
      ...
      className="inline-flex items-center gap-2 px-4 py-2
        ...
        text-2xl text-gray-900 dark:text-dark-text-white 
    ...
    >
      ...
      <button
        ...
        className="text-gray-500 hover:text-red-500 transition-colors duration-200 font-bold text-2xl"
      >
        ×
      </button>
    </div>
        ...
        <button
              ...
              className="mt-8 opacity-95 px-96 py-4 text-3xl font-bold bg-dark-text-white text-black rounded-xl dark:bg-dark-card dark:hover:shadow-lg hover:bg-violet-300 transition-all duration-300"
            >
              More
            </button>
      </main>
